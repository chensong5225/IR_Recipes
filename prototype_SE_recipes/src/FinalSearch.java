...
public class FinalSearch {
	...
	public static ArrayList<Recipe> database = DatabaseHandler.JSONHandler.readJson(Path.DataRECIPEDir);
	...
	public static void main(String[] args) throws Exception {
		...
		ArrayList<String> titles = RerankHealth.Rerank.findTitles("chicken", 20);
